...
tabnext
edit ~/personal-repos/the-odin-project/sandbox/box042-JSFormValidation/index.html
argglobal
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
lcd ~/personal-repos/the-odin-project/sandbox/box042-JSFormValidation
tabnext
edit ~/personal-repos/the-odin-project/sandbox/box042-JSFormValidation/script.js
argglobal
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
...
lcd ~/personal-repos/the-odin-project/sandbox/box042-JSFormValidation
tabnext
edit ~/personal-repos/the-odin-project/sandbox/box042-JSFormValidation/elements.js
argglobal
setlocal foldmethod=manual
setlocal foldexpr=0
setlocal foldmarker={{{,}}}
